...
class FlipkartAdapter(SiteAdapter):
    ...
    default_targets = [
        ...
        SubcategoryTarget("Mobiles & Accessories", "Mobile Covers"),
        SubcategoryTarget("Mobiles & Accessories", "Power Banks"),
        SubcategoryTarget("Mobiles & Accessories", "Bluetooth Speakers"),
        SubcategoryTarget("Mobiles & Accessories", "Earphones"),
        SubcategoryTarget("Mobiles & Accessories", "Mobile Chargers"),
        SubcategoryTarget("Mobiles & Accessories", "Memory Cards"),
        SubcategoryTarget("Electronics", "Washing Machines"),
        SubcategoryTarget("Electronics", "Microwave Ovens"),
        SubcategoryTarget("Electronics", "Water Purifiers"),
        SubcategoryTarget("Electronics", "Cameras"),
        SubcategoryTarget("Electronics", "Printers"),
        SubcategoryTarget("Electronics", "Monitors"),
        SubcategoryTarget("Electronics", "Gaming Laptops"),
        SubcategoryTarget("Electronics", "Tablets"),
        SubcategoryTarget("Electronics", "Trimmers"),
        SubcategoryTarget("Computers & Accessories", "Keyboards"),
        SubcategoryTarget("Computers & Accessories", "Mouse"),
        SubcategoryTarget("Computers & Accessories", "Pen Drives"),
        SubcategoryTarget("Computers & Accessories", "External Hard Drives"),
        SubcategoryTarget("Computers & Accessories", "Routers"),
        SubcategoryTarget("Large Appliances", "Ceiling Fans"),
        SubcategoryTarget("Large Appliances", "Air Purifiers"),
        SubcategoryTarget("Large Appliances", "Chimneys"),
        SubcategoryTarget("Large Appliances", "Geysers"),
        SubcategoryTarget("Large Appliances", "Vacuum Cleaners"),
        SubcategoryTarget("Furniture", "Sofas"),
        SubcategoryTarget("Furniture", "Beds"),
        SubcategoryTarget("Furniture", "Wardrobes"),
        SubcategoryTarget("Furniture", "Dining Tables"),
        SubcategoryTarget("Furniture", "Office Chairs"),
        SubcategoryTarget("Home & Kitchen", "Cookware"),
        SubcategoryTarget("Home & Kitchen", "Dinner Sets"),
        SubcategoryTarget("Home & Kitchen", "Bedsheets"),
        SubcategoryTarget("Home & Kitchen", "Curtains"),
        SubcategoryTarget("Home & Kitchen", "Kitchen Storage"),
        SubcategoryTarget("Home & Kitchen", "Home Decor"),
        SubcategoryTarget("Kids & Baby", "Diapers"),
        SubcategoryTarget("Kids & Baby", "Baby Toys"),
        SubcategoryTarget("Kids & Baby", "Baby Clothing"),
        SubcategoryTarget("Kids & Baby", "Strollers"),
        SubcategoryTarget("Kids & Baby", "Feeding Bottles"),
        SubcategoryTarget("Toys & Games", "Action Figures"),
        SubcategoryTarget("Toys & Games", "Board Games"),
        SubcategoryTarget("Toys & Games", "Remote Control Toys"),
        SubcategoryTarget("Sports & Fitness", "Cricket Gear"),
        SubcategoryTarget("Sports & Fitness", "Yoga Mats"),
        SubcategoryTarget("Sports & Fitness", "Gym Equipment"),
        SubcategoryTarget("Sports & Fitness", "Cycles"),
        SubcategoryTarget("Sports & Fitness", "Badminton Rackets"),
        SubcategoryTarget("Sports & Fitness", "Treadmills"),
        SubcategoryTarget("Books", "Fiction Books"),
        SubcategoryTarget("Books", "Academic Books"),
        SubcategoryTarget("Books", "Children Books"),
        SubcategoryTarget("Automotive", "Car Accessories"),
        SubcategoryTarget("Automotive", "Bike Accessories"),
        SubcategoryTarget("Automotive", "Helmets"),
        SubcategoryTarget("Automotive", "Car Care"),
        SubcategoryTarget("Bags & Luggage", "Backpacks"),
        SubcategoryTarget("Bags & Luggage", "Trolley Bags"),
        SubcategoryTarget("Bags & Luggage", "Handbags"),
        SubcategoryTarget("Bags & Luggage", "Wallets"),
        SubcategoryTarget("Jewellery & Watches", "Fashion Jewellery"),
        SubcategoryTarget("Jewellery & Watches", "Analog Watches"),
        SubcategoryTarget("Jewellery & Watches", "Digital Watches"),
        SubcategoryTarget("Eyewear", "Sunglasses"),
        SubcategoryTarget("Eyewear", "Eyeglasses"),
        SubcategoryTarget("Grocery & Gourmet", "Dry Fruits"),
        SubcategoryTarget("Grocery & Gourmet", "Snacks"),
        SubcategoryTarget("Grocery & Gourmet", "Beverages"),
        SubcategoryTarget("Health & Personal Care", "Health Supplements"),
        SubcategoryTarget("Health & Personal Care", "Personal Care Appliances"),
        SubcategoryTarget("Health & Personal Care", "Ayurveda Products"),
        SubcategoryTarget("Stationery & Office", "Notebooks"),
        SubcategoryTarget("Stationery & Office", "Office Supplies"),
        SubcategoryTarget("Stationery & Office", "Art Supplies"),
        SubcategoryTarget("Pet Supplies", "Dog Food"),
        SubcategoryTarget("Pet Supplies", "Pet Accessories"),
        SubcategoryTarget("Musical Instruments", "Guitars"),
        SubcategoryTarget("Musical Instruments", "Digital Pianos"),
        SubcategoryTarget("Tools & Home Improvement", "Power Tools"),
        SubcategoryTarget("Tools & Home Improvement", "Hand Tools"),
        SubcategoryTarget("Tools & Home Improvement", "Hardware Fittings"),
    ]
